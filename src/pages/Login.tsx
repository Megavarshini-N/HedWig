...
const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row items-stretch">
      {/* Left Panel - SKASC Campus Image */}
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-primary/80 to-secondary/80 p-8 relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('/lovable-uploads/2a846b67-e5d4-45d1-8d34-e13f72890920.png')] bg-cover bg-center opacity-80 mix-blend-overlay"></div>
